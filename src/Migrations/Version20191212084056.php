 ...
 */
final class Version20191212084056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE node (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, path VARCHAR(255) NOT NULL, parent VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, properties LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', locale VARCHAR(255) NOT NULL, INDEX IDX_857FE845A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
